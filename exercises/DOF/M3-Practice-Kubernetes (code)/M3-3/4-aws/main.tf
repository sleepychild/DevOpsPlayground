# Sample taken from https://github.com/terraform-aws-modules/terraform-aws-eks/tree/master/examples/basic
...
module "eks" {
  ...
  # Use the following line under Windows. When on Linux/macOS comment it
